    ...
    >
      ...
      <section className="relative z-10 px-6 py-24">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="relative rounded-2xl border border-white/5 bg-[#13111a] overflow-hidden mb-8 grid grid-cols-1 lg:grid-cols-12 items-center gap-8 p-6 lg:p-10">
          ...
          <div className="relative rounded-2xl border border-white/5 bg-[#13111a] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center gap-8 p-6 lg:p-10 mb-8">
            <div className="lg:col-span-7 relative z-10 order-2 lg:order-1">
              <div className="flex items-center gap-2 mb-4">

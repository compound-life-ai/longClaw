          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FeatureCard
                ...
                description="After a week of meal logging, the agent summarizes your intake vs RDA targets — highlighting gaps and strengths with actionable food suggestions."
                tag="weekly"
                tagColor="green"
              >
                <ChatMock messages={[
                  { role: "assistant", text: "<b>weekly nutrition review</b> &mdash; Mar 13&ndash;19<br/><span style='opacity:0.7'>avg: 2,080 kcal &middot; 128g protein (91% RDA)<br/><b>strengths:</b> selenium 142% &middot; vitamin D 118% &middot; omega-3 105%<br/><b>gaps:</b> calcium 52% &middot; zinc 61% &middot; fiber 68%<br/>top picks: greek yogurt, pumpkin seeds, lentils</span><br/><span style='opacity:0.5'>based on 19 meals across 7 days</span>" },
                ]} />
              </FeatureCard>
            </div>
          </div>

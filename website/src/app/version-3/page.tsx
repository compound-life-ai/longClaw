...
/* ─── SVG Icons (generated by Gemini 3.1 Pro Preview via droid) ─── */
...
const IconDna = ({ className = "" }: { className?: string }) => (
...
const IconApple = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M9 6c-3.5 0-5.5 2.5-5.5 5.5 0 2.5 2.5 4.5 5.5 4.5s5.5-2 5.5-4.5C14.5 8.5 12.5 6 9 6z" /><path d="M9 6V2a3 3 0 0 1 3 3" /></svg>
);
...
const IconHeartPulse = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M10.5 4.5A3.5 3.5 0 0 1 16 7c0 4-7 8-7 8s-7-4-7-8a3.5 3.5 0 0 1 5.5-2.5" /><path d="M2 9h3l1.5-3 2 6 1.5-3h4" /></svg>
);
const IconRunning = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="11" cy="4" r="2" /><path d="M11 6v4l-3 4" /><path d="M11 10l3 4" /><path d="M6 7l4 1 3-2" /></svg>
);
    ...
    <nav className="sticky top-0 z-50 border-b border-claw-border bg-claw-bg/80 backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <img src="/logo.svg" alt="Longevity OS" className="h-5 w-auto" />
...
function ShowcaseTabs() {
  ...
  const tabs = [
    { id: "nutrition", label: "Weekly Review", icon: <IconChart className="w-4 h-4" /> },
    { id: "patterns", label: "Pattern Detection", icon: <IconSearch className="w-4 h-4" /> },
    { id: "analysis", label: "Deep Analysis", icon: <IconDna className="w-4 h-4" /> },
  ];
            ...
            <div className="bg-claw-bg rounded-xl border border-claw-border p-5 mt-4 space-y-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <img src="/logo.svg" alt="" className="h-3.5 w-auto" />
                      ...
                      {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((d, i) => {
                        ...
                        return (
                          <div key={d} className="text-center">
                            ...
                            {bad && <div className="text-[8px] text-claw-amber mt-0.5 flex items-center gap-0.5"><IconCoffee className="w-2.5 h-2.5 inline" /> 5pm</div>}
                          </div>
                        );
                      })}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-3">
                {[
                  { icon: <IconApple className="w-4 h-4 text-claw-red" />, text: "Nutrition tracking from photos and text" },
                  { icon: <IconMoon className="w-4 h-4 text-claw-red" />, text: "Sleep analysis from wearable data" },
                  { icon: <IconHeartPulse className="w-4 h-4 text-claw-red" />, text: "HRV & heart rate pattern detection" },
                  { icon: <IconRunning className="w-4 h-4 text-claw-red" />, text: "Activity and recovery insights" },
                ].map((item, i) => (
